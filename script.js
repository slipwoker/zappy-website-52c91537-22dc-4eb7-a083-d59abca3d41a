    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "XADO ISRAEL משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '52c91537-22dc-4eb7-a083-d59abca3d41a',
                    name: data.name || '',
                    email: data.email || '',
...
function renderProductDetail(container, product, t) {
  ...
  if (hasVariants) {
    ...
    const groupsHtml = Object.entries(attributeGroups).map(([attrKey, values]) => {
